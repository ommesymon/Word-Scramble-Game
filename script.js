...
const words = [
    'planet', 'garden', 'computer', 'javascript', 'python', 'scramble', 'victory',
    'dolphin', 'coffee', 'ocean', 'notebook', 'keyboard', 'screen', 'weather',
    'bicycle', 'adventure', 'friendship', 'programming', 'development', 'mystery',
    'fantasy', 'artificial', 'puzzle', 'enthusiasm', 'strategy', 'landscape',
    'knowledge', 'imagination', 'destination', 'exploration'
];
